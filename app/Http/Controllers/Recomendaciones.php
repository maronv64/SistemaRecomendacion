...
class Recomendaciones extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $recomendacionesVar->porcentajeCumplimiento="0";
        $recomendacionesVar->estadoRecomendacion="sin asignar";
    ...
    public function FiltrarRecomendaciones($id)
    {
               $recomendacionesall=Recomendacion::with(['subtemasV2'])->where('subtema_id',$id )->get();
        //dd($informeall);
        return response()->json($recomendacionesall);    
    }
