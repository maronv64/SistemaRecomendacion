             ...
             $.each(data, function(i, item) { // recorremos cada uno de los datos que retorna el objero json n valores
                ...
                $('#tablaCargo').append(
                    '<tr>'+
                        ...
                        '<td>'+
                          '<button type="button" class="btn btn-warning" onclick="editarCargos('+item.id+')"><i class="fa fa-edit"></i></button>  '+
                        '</td>'+
                        '<td>'+
                          '  <button type="button" class="btn btn-danger" onclick="eliminarCargos('+item.id+')"><i class="fa fa-trash"></button>'+
                        '</td>'+
