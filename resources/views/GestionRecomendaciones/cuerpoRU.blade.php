  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header" align="center">
          <h3 class="modal-title" > <b><i class="fa fa-file-text-o"></i> ASIGNAR USUARIOS</b></h5>
      ...
      <ul class="nav nav-tabs">
        ...
        @include('GestionRecomendaciones.ventanaModalRecomendacionesUsuarios') 
        </div>
        <br>
        <br>
        <div id="mostrar" class="tab-pane fade">
         @include('GestionRecomendaciones.MostrarRecomendacionesUsuario')   
        </div>
      </div>
