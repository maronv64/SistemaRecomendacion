             ...
             <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="{{ url('/Cargo')}} "><i class="fa fa-file-text-o"></i>Gestion Cargo </a></li>  
                    ...
                    <li><a href="{{ url('/Tarea')}}"><i class="fa fa-file-o"></i>Gestion Tarea</a></li>  
                    
                </ul>
            </li>

            <li class="treeview">
                <a href="#"><i class='fa fa-bar-chart-o'></i> <span>RECOMENDACIONES</span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                
                  <li><a href="{{ url('/AsignarRecomendacion')}} "><i class="fa fa-file-text-o"></i>MIS RECOMENDACIONES </a></li>  
