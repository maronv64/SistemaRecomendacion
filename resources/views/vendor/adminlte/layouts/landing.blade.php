...
<div id="app">
    ...
    <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><b>SRCN</b></a>
            </div>
    ...
    <div id="footerwrap">
        <div class="container">
            <div class="col-lg-5">
                ...
                <p>
                    Calle Col&oacute;n y Bolivar,<br/>
                    Chone,<br/>
                    Ecuador
                </p>
            </div>
            ...
            <div class="col-lg-7">
                ...
                <form role="form" action="#" method="post" enctype="plain">
                    <div class="form-group">
                        ...
                        <input type="name" name="Name" class="form-control" id="name1" placeholder="Ingrese su Nombre">
                    </div>
                    <div class="form-group">
                        <label for="email1">Correo</label>
                        <input type="email" name="Mail" class="form-control" id="email1" placeholder="Ingrese su Correo">
                    </div>
                    <div class="form-group">
                        <label>Mensaje</label>
    ...
    <div id="c">
        <div class="container">
            <p>              
                <strong>Copyright &copy; 2018 <a href="https://www.chone.gob.ec/">GAD Chone</a>.</strong>
                <br/>
